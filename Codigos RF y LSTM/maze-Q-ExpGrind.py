...
def gather_experiences(grid_size, seq_length, episodes, n_mazes):
    ...
    complete_mazes = 0
    n_sequences = 0
    env = gym.make("meta-maze-2D-v0", enable_render=False, task_type="ESCAPE")
...
# Change at will
grid_size = 25     # Tamaño de los laberintos
episodes = 100      # Episodios para aprender la política Q en cada laberinto
n_mazes = 10000       # Nº de laberintos de los que se recogerán experiencias
sequence_length = 6 # Tamaño de las secuencias de experiencias. Mayor tamaño requerirá mayores laberintos.

result = gather_experiences(episodes=episodes,seq_length=sequence_length,grid_size=grid_size,n_mazes=n_mazes)

filename = "Experiences-{}-{}-{}.pickle".format(grid_size,episodes,n_mazes)
